...
export const CaseStudyPickup = () => {
  return (
    <div className="bg-black min-h-screen w-full">
      {/* Back button only — navbar & footer are part of the case study content */}
      ...
      >
        <div className="w-full aspect-video rounded-2xl overflow-hidden bg-[#111]">
          <iframe
            src="https://drive.google.com/file/d/1ipsZbVaDGm0jmFdUsEd9jRz3g6F4VKCy/preview"
      ...
      {/* Case study image (contains its own navbar + footer) */}
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        <img
          ...
          alt="Map pick up experience case study"
          className="w-full h-auto block"
        />
      </motion.div>

      {/* Standalone footer row with updated CV link */}
