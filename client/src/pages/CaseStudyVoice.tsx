      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-20 py-10">
        ...
        >
          <div className="flex flex-wrap gap-2 items-center">
            <span className="font-['Inter_Tight',Helvetica] font-medium text-[#95989c] text-base">Conversation design</span>
            <span className="text-[#656567] text-base">/</span>
            <span className="font-['Inter_Tight',Helvetica] font-medium text-[#95989c] text-base">Voice assistant</span>
          </div>
